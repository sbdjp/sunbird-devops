...
# Description: Technical document on configuring  FAQ urls
...
faqURL="https://ntpstagingall.blob.core.windows.net/public/faq/resources/res" # This value need to be taken from implementation team tomorrow
