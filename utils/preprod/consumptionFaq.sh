...
consumptionFaqsPublicUrl="https://preprodall.blob.core.windows.net/public/faq/consumption-faqs.html" # This value need https://preprod.ntp.net.in/faq/consumption-faqs.htmlto be taken from implementation team tomorrow
