#!/bin/bash
# Title: Configuring  location skip button visibility
...
### Set The location config form api
...
curl -s -X POST \
  ...
  -d '{"request":{"type":"config","subType":"location","action":"get","component":"*","framework":"*","rootOrgId":"*","data":{"templateName":"location","action":"get","fields":[{"name":"Skip Location","code":"skip","values":[]}]}}}' 

# Check the status of location config form api
