#!/bin/bash
# Title: Configuring FAQ url
# Description: Technical document on configuring  FAQ url
...
faqURL="https://preprodall.blob.core.windows.net/public/faq/resources/res" # This value need https://preprod.ntp.net.in/faq/consumption-faqs.htmlto be taken from implementation team tomorrow
...
curl -s -X GET \
  $sunbirdBaseURL/api/data/v1/system/settings/get/faqURL \
  -H "Authorization: Bearer $Bearer" \
  -H 'Content-Type: application/json'
