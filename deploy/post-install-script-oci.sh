...
create_master_categories(){
    ...
    # following changes are suggested from community and new values will be required
    ...
    curl -XPOST "http://${learningservice_ip}:8080/learning-service/framework/v3/category/master/create" -H 'Content-Type: application/json' -H "X-Channel-Id: ${organisation}" --data-raw '{"request": {"category": {"name": "board","code": "board", "targetIdFieldName": "targetBoardIds", "searchLabelFieldName": "se_boards","searchIdFieldName": "se_boardIds","orgIdFieldName" : "brd_orgidfieldname"}}}'
    curl -XPOST "http://${learningservice_ip}:8080/learning-service/framework/v3/category/master/create" -H 'Content-Type: application/json' -H "X-Channel-Id: ${organisation}" --data-raw '{"request": {"category": {"name": "medium","code": "medium", "targetIdFieldName": "targetMediumIds","searchLabelFieldName": "se_mediums","searchIdFieldName": "se_mediumIds","orgIdFieldName" : "me_orgfieldname"}}}'
    curl -XPOST "http://${learningservice_ip}:8080/learning-service/framework/v3/category/master/create" -H 'Content-Type: application/json' -H "X-Channel-Id: ${organisation}" --data-raw '{"request": {"category": {"name": "subject","code": "subject", "targetIdFieldName": "targetSubjectIds","searchLabelFieldName": "se_subjects","searchIdFieldName": "se_subjectIds","orgIdFieldName" : "se_orgidfieldname"}}}'
    curl -XPOST "http://${learningservice_ip}:8080/learning-service/framework/v3/category/master/create" -H 'Content-Type: application/json' -H "X-Channel-Id: ${organisation}" --data-raw '{"request": {"category": {"name": "gradeLevel","code": "gradeLevel","targetIdFieldName": "targetGradeLevelIds","searchLabelFieldName": "se_gradeLevels", "searchIdFieldName": "se_gradeLevelIds","orgIdFieldName" : "grd_orgidfieldname"}}}'
    curl -XPOST "http://${learningservice_ip}:8080/learning-service/framework/v3/category/master/create" -H 'Content-Type: application/json' -H "X-Channel-Id: ${organisation}" --data-raw '{"request": {"category": {"name": "topic","code": "topic","targetIdFieldName": "targetTopicIds","searchLabelFieldName": "se_topics","searchIdFieldName": "se_topicIds","orgIdFieldName" : "topic_orgidfieldname"}}}'
}
...
system_settings(){
    ...
    -d '{
       "request":{
  		   "id": "tncConfig",
		   "field": "tncConfig",
		   "value": "{\"latestVersion\":\"latest\",\"latest\":{\"url\":\"'${proto}':\/\/'${sunbird_azure_public_storage_account_name}'.compat.objectstorage.ap-melbourne-1.oraclecloud.com\/contents\/terms-and-conditions\/terms-and-conditions-v9.html#termsOfUse\"}}"
       }
    }'
    ...
    -d '{
       "request":{
  		   "id": "orgAdminTnc",
		   "field": "orgAdminTnc",
		   "value": "{\"latestVersion\":\"latest\",\"latest\":{\"url\":\"'${proto}':\/\/'${sunbird_azure_public_storage_account_name}'.compat.objectstorage.ap-melbourne-1.oraclecloud.com\/contents\/terms-and-conditions\/terms-and-conditions-v9.html#administratorGuidelines\"}}"
       }
    }'
    ...
    -d '{
       "request":{
  		   "id": "groupsTnc",
		   "field": "groupsTnc",
		   "value": "{\"latestVersion\":\"latest\",\"latest\":{\"url\":\"'${proto}':\/\/'${sunbird_azure_public_storage_account_name}'.compat.objectstorage.ap-melbourne-1.oraclecloud.com\/contents\/terms-and-conditions\/terms-and-conditions-v9.html#groupGuidelines\"}}"
       }
    }'
...
echo -e "\e[0;90m${bold}user password: $user_passwords ${normal}"
printf "\n\n"
