...
<body class="${properties.kcBodyClass!}">
    <main>
    <div id="kc-logo"><a href="${properties.kcLogoLink!'#'}" title="kc-logo-wrapper"><div id="kc-logo-wrapper"></div></a></div>
            ...
            <div id="kc-content" class="${properties.kcContentClass!}">
                <div id="kc-content-wrapper" class="${properties.kcContentWrapperClass!}">
                    ...
                    <script type="text/javascript">
                        ...
                        if(sessionTenant){
                            var imgSrc = origin+"/"+sessionTenant+"/header.png";
                        }else{
                            var imgSrc = origin+"/assets/imgs/logos.svg";
                        }
                        ...
                        if(logoImg){
                            ...
                            logoImg.src = imgSrc;
                            logoImg.addEventListener("error", ()=>{ logoImg.onerror=null;logoImg.src=''+origin+'/assets/imgs/logos.svg'});
                        }
